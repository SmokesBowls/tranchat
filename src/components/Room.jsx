...
function Room() {
  ...
  return (
    <div className="relative h-screen">
      ...
      <button
        onClick={handleExit}
        className="absolute top-4 right-4 z-10 text-white bg-black bg-opacity-50 rounded-full p-2 hover:bg-opacity-70 focus:outline-none focus-visible:ring-2 focus-visible:ring-white"
      ...
      <div className="absolute right-0 top-0 bottom-0 w-80 bg-black bg-opacity-50 text-white p-4 flex flex-col">
        ...
        <div className="flex gap-2">
          <input
            ...
            className="flex-1 bg-gray-700 text-white px-3 py-2 rounded focus:outline-none focus-visible:ring-2 focus-visible:ring-blue-500"
          />
          <button
            onClick={handleSendMessage}
            className="bg-blue-500 hover:bg-blue-600 px-4 py-2 rounded focus:outline-none focus-visible:ring-2 focus-visible:ring-blue-300"
          >
            Send
          </button>
        </div>
