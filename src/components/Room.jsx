...
function Room() {
  ...
  return (
    <div className="relative h-screen">
      ...
      <button
        onClick={handleExit}
        className="absolute top-4 right-4 z-10 text-white bg-black bg-opacity-50 rounded-full p-2 hover:bg-opacity-70 focus-visible:ring-2 focus-visible:ring-white focus:outline-none"
